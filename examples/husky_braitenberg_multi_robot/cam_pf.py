...
def detect_red(camera, dp_name):
    ...
    processed_image = JsonDataPack(dp_name, "gazebo")
...
@EngineDataPack(keyword='camera1', id=DataPackIdentifier('husky_1::eye_vision_camera::camera', 'gazebo'))
@EngineDataPack(keyword='camera2', id=DataPackIdentifier('husky_2::eye_vision_camera::camera', 'gazebo'))
@PreprocessingFunction("gazebo")
def cam_pf(camera1, camera2):

    return [detect_red(camera1, "processed_image_1"), detect_red(camera2, "processed_image_2")]
