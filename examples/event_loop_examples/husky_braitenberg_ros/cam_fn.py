...
from  nrp_core.data.nrp_ros.sensor_msgs import Image
...
@RosSubscriber(keyword="camera", address="/husky/camera", type=Image)
...
def detect_red(camera):
    ...
    if camera:
        ...
        bridge = CvBridge()
        cv_image = bridge.imgmsg_to_cv2(Image_to_ros(camera), desired_encoding='passthrough')
