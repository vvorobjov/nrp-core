...
def transceiver_function(actors):
    back_left_j   = JsonDevice("husky::back_left_joint", "gazebo")
    back_right_j  = JsonDevice("husky::back_right_joint", "gazebo")
    front_left_j  = JsonDevice("husky::front_left_joint", "gazebo")
    front_right_j = JsonDevice("husky::front_right_joint", "gazebo")
