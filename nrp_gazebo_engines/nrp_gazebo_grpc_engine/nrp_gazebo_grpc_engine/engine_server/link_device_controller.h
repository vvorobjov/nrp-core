...
#ifndef LINK_GRPC_DEVICE_CONTROLLER_H
#define LINK_GRPC_DEVICE_CONTROLLER_H
...
namespace gazebo
{
	        ...
	        : public DeviceController<google::protobuf::Message>
	{
		...
		public:
            LinkGrpcDeviceController(const std::string &linkName, const physics::LinkPtr &link)
			    : _name(linkName),
			      _link(link)
			{}
...
#endif // LINK_GRPC_DEVICE_CONTROLLER_H
