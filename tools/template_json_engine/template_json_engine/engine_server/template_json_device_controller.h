...
#ifndef ${engine_name_uppercase}_JSON_DEVICE_CONTROLLER_SERVER_H
#define ${engine_name_uppercase}_JSON_DEVICE_CONTROLLER_SERVER_H

#include "nrp_json_engine_protocol/engine_server/json_device_controller.h"

class ${engine_name}JSONDeviceController
    : public JsonDeviceController
{
	public:
		${engine_name}JSONDeviceController(const std::string & deviceName,
		 ...
		 */
		nlohmann::json * getDeviceInformation() override;
};

#endif // ${engine_name_uppercase}_JSON_DEVICE_CONTROLLER_SERVER_H
