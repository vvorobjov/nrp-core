...
#ifndef NEST_KERNEL_DEVICE_CONTROLLER_H
#define NEST_KERNEL_DEVICE_CONTROLLER_H
...
class NestKernelDeviceController
	: public JsonDeviceController
{
	public:
		NestKernelDeviceController(const DeviceIdentifier & devID, boost::python::dict nest);
...
#endif // NEST_KERNEL_DEVICE_CONTROLLER_H
