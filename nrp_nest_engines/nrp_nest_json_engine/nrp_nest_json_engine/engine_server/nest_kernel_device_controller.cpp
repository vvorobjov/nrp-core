...
NestKernelDeviceController::NestKernelDeviceController(const DeviceIdentifier & devID, boost::python::dict nest)
...
void NestKernelDeviceController::handleDeviceData(const nlohmann::json &)
{

}


nlohmann::json *NestKernelDeviceController::getDeviceInformation()
{
