...
def LeakyIntegrator(nest, name, neurons, n, n_type, leaky_params, conn_spec, delay):
    ...
    nest.Connect(neurons,
             ...
             conn_spec=conn_spec,
             syn_spec=syn_dict)
    RegisterDataPack(name, leaky_cells)
...
def LeakyIntegratorAlpha(nest, name, neurons, n=1, conn_spec='all_to_all'):
    alpha_params = {
        ...
        't_ref': 0.1,
        'I_e': 0.0}
    LeakyIntegrator(nest, name, neurons, n, 'iaf_psc_alpha', alpha_params, conn_spec, 0.1)
...
def LeakyIntegratorExp(nest, name, neurons, n=1, conn_spec='all_to_all'):
    exp_params = {'V_th': 1e10,
                  ...
                  't_ref': 0.1,
                  'I_e': 0.0}
    LeakyIntegrator(nest, name, neurons, n, 'iaf_psc_exp', exp_params, conn_spec,
