...
#ifndef BUILD_JSON_SERVER_H
#define BUILD_JSON_SERVER_H

#include "nrp_json_engine_protocol/engine_server/engine_json_server.h"
#include "nrp_general_library/utils/python_interpreter_state.h"

class BuildJSONServer
    : public EngineJSONServer
{
    public:
        BuildJSONServer(const std::string &serverAddress, const std::string &engineName, const std::string &registrationAddress);
        ~BuildJSONServer() = default;
