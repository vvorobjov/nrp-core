...
#include "build_json_engine/engine_server/build_json_server.h"
#include "build_json_engine/engine_server/build_json_datapack_controller.h"

BuildJSONServer::BuildJSONServer(const std::string &serverAddress,
...
SimulationTime BuildJSONServer::runLoopStep(SimulationTime timeStep)
{
...
nlohmann::json BuildJSONServer::initialize(const nlohmann::json &/*data*/, EngineJSONServer::lock_t &/*datapackLock*/)
{
    ...
    this->registerDataPackNoLock(datapackName, new BuildJSONDataPackController(datapackName, this->_engineName));
...
nlohmann::json BuildJSONServer::shutdown(const nlohmann::json &/*data*/)
{
...
nlohmann::json BuildJSONServer::reset(EngineJSONServer::lock_t &/*datapackLock*/)
{
