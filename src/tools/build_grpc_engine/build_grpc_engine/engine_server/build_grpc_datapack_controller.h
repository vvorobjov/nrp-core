...
#ifndef BUILD_GRPC_DATAPACK_CONTROLLER_SERVER_H
#define BUILD_GRPC_DATAPACK_CONTROLLER_SERVER_H
...
class BuildGrpcDataPackController
    : public DataPackController<google::protobuf::Message>
{
    public:
        BuildGrpcDataPackController(const std::string & datapackName,
...
#endif // BUILD_GRPC_DATAPACK_CONTROLLER_SERVER_H
