...
int main(int argc, char * argv[])
{
    ...
    json_utils::setDefault<std::string>(config.at("EngineConfig"), "EngineType", BuildGrpcConfigConst::EngineType);
    ...
    BuildEngineGrpcClient client(config.at("EngineConfig"), ProcessLauncherInterface::unique_ptr{});
    ...
    // Instantiate Engine
    auto wrapper = new BuildEngine(client.engineName(), protobufPluginsPath, protobufPlugins);
