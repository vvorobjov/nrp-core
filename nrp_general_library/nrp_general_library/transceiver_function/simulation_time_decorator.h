...
#ifndef SIMULATION_TIME_DECORATOR_H
#define SIMULATION_TIME_DECORATOR_H
...
/*!
 * \brief Class for retrieving simulation time in Functions, mapped to SimulationTime python decorator
 */
    ...
    : public TransceiverDataPackInterface
{
    public:
        ...
        {
            kwargs[this->_keyword] = this->getFunctionManager()->getSimulationTime().count();
...
#endif // SIMULATION_TIME_DECORATOR_H
