...
/*!
 * \brief Uses the TF framework to execute device transformation operations
 */
class TFManagerHandle : public DeviceHandle {
...
public:
    ...
    /*!
     * \brief Execute PreprocessingFunctions for each engine and place output devices in its cache
     *
...
private:
    ...
    /*! \brief  TransceiverFunctionManager handling device operations */
